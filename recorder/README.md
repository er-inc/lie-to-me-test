...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Wolox/recorder?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Error Tracking](https://d26gfdfi90p7cf.cloudfront.net/rollbar-badge.144534.o.png)](https://rollbar.com)

`[![Codestats](http://codestats-url/organizations/your-organization/projects/recorder/badge)](http://codestats-url/organizations/your-organization/projects/recorder/badge)`
...
- Clone the repository by running `git clone git@github.com:Wolox/recorder.git`
- Go to the project root by running `cd recorder`
...
```bash
  ...
  CREATE ROLE "recorder" LOGIN CREATEDB PASSWORD 'recorder';
```
